		...
		<div id='Testimonials' className='lg:px-20 px-4 py-20'>
			<div className='container mx-auto'>
				...
				<div className='container flex flex-col-reverse items-center mx-auto sm:flex-row mt-6'>
					<div className='w-full lg:w-2/2 sm:w-full mb-8 lg:mr-10 bg-[#F5F5F5] p-10 rounded-lg relative'>
					...
					<div className='w-full lg:w-1/2 sm:w-full mb-8 bg-[#F5F5F5] p-10 rounded-lg'>
						<div className='flex flex-col justify-start max-w-lg mx-auto lg:ml-0 lg:mr-auto lg:max-w-none'>
