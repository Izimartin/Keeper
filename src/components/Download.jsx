...
function Download() {
	return (
		<div className='bg-[#f7fdff] lg:px-20 px-20 py-0'>
				...
				<div className='w-full lg:w-1/2 mr-16'>
					<div className='flex flex-col justify-start max-w-lg mx-auto lg:ml-0 lg:mr-auto lg:max-w-none'>
						...
						<p className='mt-6 mb-8 '>
							...
							You get to keep track of every and any task you’ve highlighted.
						</p>
					</div>
				</div>
			...
			<div
				className='container flex mx-auto sm:flex-row py-32 '
				style={{
					backgroundImage: `url('/src/assets/img/background-img.png')`,
					backgroundSize: "60%",
					backgroundPosition: "10% 0px",
					backgroundRepeat: "no-repeat",
				}}>
				<div className='w-full lg:w-1/2 ml-128'>
					<div className='flex flex-col max-w-lg mx-auto lg:ml-0 lg:mr-auto lg:max-w-none'>
						<h4 className='text-3xl font-bold sm:text-4xl'>
